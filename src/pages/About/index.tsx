...
const AboutPage = () => {
  return (
    <>
      <Seo title="About Klein Kastings | Michigan Aluminum Foundry" description="Learn about Klein Kastings, a new aluminum foundry in West Michigan backed by over 18 years of metal casting experience." path="/about" />
