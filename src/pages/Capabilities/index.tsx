...
const CapabilitiesPage = () => {
  return (
    <>
      <Helmet>
        <title>Capabilities | Klein Kastings</title>
        <meta name="description" content="Explore Klein Kastings capabilities including design, shell process casting, permanent mold casting, machining, polishing, and finishing." />
