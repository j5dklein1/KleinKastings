...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Klein Kastings | Aluminum Foundry in Michigan</title>
        <meta name="description" content="Klein Kastings is a Michigan aluminum foundry offering shell core and mold casting, permanent mold casting, CNC machining, and finishing." />
