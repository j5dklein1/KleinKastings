...
const HomePage = () => {
  ...
  return (
    <>
      <Seo title="Klein Kastings | Aluminum Casting Foundry in West Michigan" description="Klein Kastings provides custom aluminum casting, shell molding, permanent mold casting, CNC machining, polishing, and finishing services for manufacturers across West Michigan and the Grand Rapids area." path="/" />
    <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                At Klein Kastings, we provide high-quality aluminum castings for customers throughout West Michigan, including Grand Rapids, Ottawa County, Holland, Muskegon, and the surrounding manufacturing region. We work with manufacturers, engineers, and purchasing teams looking for dependable cast aluminum components for industrial, commercial, and custom applications.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                From prototype work to production runs, our team is focused on delivering castings that meet your requirements for quality, appearance, and performance. We also support machining, polishing, and finishing services so your parts arrive closer to production-ready. If you need a trusted aluminum foundry serving the Grand Rapids area, we're ready to help.
              </p>
      ...
      <section className="py-20 bg-industrial-50 border-y border-gray-200">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-10">
            <p className="text-accent font-heading tracking-[0.3em] text-sm uppercase mb-4">Serving West Michigan Manufacturers</p>
            <h2 className="text-4xl md:text-5xl font-heading text-industrial-900 mb-6">Custom Aluminum Casting for Michigan Manufacturers</h2>
            <p className="text-lg text-gray-600 leading-relaxed mb-5">
              Klein Kastings provides custom aluminum casting services for manufacturers throughout West Michigan and the greater Grand Rapids area. We specialize in durable, high-quality aluminum cast components for industrial, commercial, and specialty applications.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed mb-5">
              From prototypes to production runs, our team helps turn designs and concepts into reliable cast parts with consistent quality, responsive lead times, and castings that machine and finish cleanly.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Located in West Michigan, Klein Kastings proudly serves companies across Grand Rapids, Holland, Muskegon, and the surrounding manufacturing region with aluminum casting, CNC machining, polishing, and finishing support.
            </p>
          </div>
          <div className="max-w-3xl mx-auto bg-white border border-gray-200 rounded-sm p-8 shadow-sm">
            <h3 className="text-2xl font-heading text-industrial-900 mb-4 text-center">Need a casting quote?</h3>
            <p className="text-gray-600 text-center mb-6">Send us your drawing, model, or concept and we’ll review your project.</p>
            <div className="flex justify-center">
              <Link
                to="/contact"
                className="bg-accent hover:bg-accent-hover text-black font-bold py-3 px-8 rounded-sm transition-all font-heading tracking-wide"
              >
                Request a Quote
              </Link>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Comprehensive solutions for custom aluminum castings, machining, polishing, and finishing in West Michigan.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Finishing & CNC',
                desc: 'CNC machining, polishing, and finishing services to move parts closer to production-ready.',
