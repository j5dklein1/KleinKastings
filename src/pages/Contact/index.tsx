...
const ContactPage = () => {
  ...
  return (
    <>
      <Seo title="Contact Klein Kastings | Request a Quote" description="Contact Klein Kastings for aluminum casting, CNC machining, shell mold, permanent mold, and finishing projects in West Michigan." path="/contact" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white p-8 md:p-10 rounded-sm shadow-lg h-full">
              ...
              <form onSubmit={handleSubmit} noValidate name="contact" method="POST" action="/thank-you" data-netlify="true" netlify-honeypot="bot-field">
